...
using ShipParticularsApi.Tests.Tests.Helper;
...
using static ShipParticularsApi.Tests.Tests.Builders.Params.ShipParticularParamTestBuilder;
using static ShipParticularsApi.Tests.Tests.Builders.Params.ShipSatelliteParamTestBuilder;
using static ShipParticularsApi.Tests.Tests.Builders.Params.SkTelinkCompanyShipParamTestBuilder;


namespace ShipParticularsApi.Tests.Tests.Services
{
    public class ShipParticularsServiceTestcontainersTest(WebApplicationFactoryWithTestcontainers factory, ITestOutputHelper output)
                                : IClassFixture<WebApplicationFactoryWithTestcontainers>, IAsyncLifetime
    {

        private readonly WebApplicationFactoryWithTestcontainers _factory = factory;
        ...
        public async Task Case6()
        {
            ...
            await serviceProvider.SeedDataAsync(NoService(shipKey).Build());

            var param = ShipParticularsParam()
                .WithShipKey(shipKey)
                .WithCallsign("NEW_SIGN")
                .WithShipName("NEW_NAME")
                .WithShipType("PASSENGER")
                .WithShipCode("NEW_CODE")
                .Build();
        ...
        public async Task Case8()
        {
            ...
            await serviceProvider.SeedDataAsync(AisOnly(shipKey).Build());
        ...
        public async Task Case12()
        {
            ...
            await serviceProvider.SeedDataAsync(UsingSkTelink(shipKey, "TEST_USER_01").Build());
        ...
        public async Task Case13()
        {
            ...
            actual.ShipServices.Should().ContainSingle().And.ContainEquivalentOf(
                KtSatService(shipKey).Build(),
                options => options.Including(s => s.ShipKey).Including(s => s.ServiceName)
            );
        ...
        public async Task Case15()
        {
            ...
            await serviceProvider.SeedDataAsync(UsingKtSat(shipKey, userId).Build());
        ...
        public async Task Case16()
        {
            ...
            await serviceProvider.SeedDataAsync(UsingSkTelink(shipKey, userId).Build());
        ...
        {
            _output.WriteLine($"container id = {_factory.ContainerId}");
